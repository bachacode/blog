            ...
            <div class="w-full px-4">
                <div x-show.transition.origin.top="isOpen()" class="absolute left-0 z-40 w-full bg-white rounded shadow top-100 max-h-select" x-on:click.away="close">
                    <div class="flex flex-col w-full overflow-y-auto">
                        <template x-for="[id, option] in Object.entries(options)" :key="id" class="overflow-auto">
                            <div class="w-full border-b border-gray-200 rounded-t cursor-pointer hover:bg-gray-100" @click="select(id,$event)">
                                <div class="relative flex items-center w-full p-2 pl-2 border-l-2 border-transparent">
                                    <div class="flex items-center justify-between w-full">
                                        <div class="mx-2 leading-6" x-model="id" x-text="option.text"></div>
